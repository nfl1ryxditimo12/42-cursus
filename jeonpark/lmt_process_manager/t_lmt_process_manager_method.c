...
/*   Updated: 2021/10/12 21:13:13 by jeonpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	lmt_process_manager_execute_token_sublist(t_handler *handler, t_lmt_token_sublist *token_sublist, int pipe_in_fd)
{
	...
	lmt_process_list_set_by_token_sublist(process_list, token_sublist, pipe_in_fd);
...
int	lmt_process_manager_execute(t_handler *handler)
{
	...
	exit_code = lmt_process_manager_execute_token_sublist(handler, token_sublist, FD_NONE);
