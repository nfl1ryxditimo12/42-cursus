...
{
	std::cout << CYN << "max_size" << NC << " [" << (ft_map.max_size() == std_map.max_size() ? "\e[0;32mOK\e[0m" : "\e[0;31mFALSE\e[0m") << "] - ft: " << ft_vec.max_size() << ", std: " << std_vec.max_size() << std::endl;
	std::cout << CYN << "size" << NC << "     [" << (ft_map.size() == std_map.size() ? "\e[0;32mOK\e[0m" : "\e[0;31mFALSE\e[0m") << "] - ft: " << ft_vec.size() << ", std: " << std_vec.size() << std::endl;
